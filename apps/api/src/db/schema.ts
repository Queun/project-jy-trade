...
export const batches = sqliteTable(
  "batches",
  {
    ...
    allocationPriority: text("allocation_priority", { enum: ["suite_first", "goods_first"] }).notNull().default("suite_first"),
    createdAt: text("created_at").notNull(),
...
export const reviewLines = sqliteTable(
  "review_lines",
  {
    ...
    productType: text("product_type", { enum: ["goods", "suite"] }).notNull().default("goods"),
    componentStockJson: text("component_stock_json").notNull().default("[]"),
...
export const warehouseUsageSettings = sqliteTable("warehouse_usage_settings", {
  ...
  sharedComponentPriority: text("shared_component_priority", { enum: ["suite_first", "goods_first"] }).notNull().default("suite_first"),
...
export const wdtSyncRuns = sqliteTable(
  ...
  {
    id: text("id").primaryKey(),
    trigger: text("trigger", { enum: ["manual", "quick_manual", "hourly", "startup"] }).notNull(),
